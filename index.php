...
ul.img-list {     //for recommended movie section
        ...
        <div class="carousel slide wet-asphalt hidden-xs">
         	...
         	<ol class="carousel-indicators">
     		 ...
     		 <div class="carousel-inner" role="listbox">
                <div class="item active" style="background-image: url(images/slider/bg1.jpg); width:533; height:400px;">   <!-- width:533; height:400px;-->
                    
					<div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    <h2 class="animation animated-item-1">PickurFlick indie</h2>
                                    <p class="animation animated-item-2">Best Video Streaming site</p>
                                </div>
                            </div>
                        </div>
                    </div>
     			 ...
     			 <div class="item" style="background-image: url(images/slider/bg2.jpg); width:533; height:400px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                                    <h2 class="boxed animation animated-item-1">Watch Anywhere,Anytime..</h2>
                                    <p class="boxed animation animated-item-2">On any Device</p>
                                    <br>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg); width:533; height:400px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content centered">
                                    <h2 class="animation animated-item-1">Latest Movies & Trends at PickurFlick</h2>
                                    <p class="animation animated-item-2">Go Pick your Flick!!:D</p>
                                    <a class="btn btn-md animation animated-item-3" href="#">Learn More</a>
                                </div>
                            </div>
							<!-- Vimeo video -->
...
<!-- Recommended Movies section -->
			...
			<h2 style="color:white">Recommended Flicks</h2>
					
				<?php 
					 $sql = @mysql_query("SELECT * FROM movies",$con);
					 $arr = fetch_array($sql);
					 $l = count($arr);$m = ceil($l/3); $k=0;
					 //echo '<h2 style="color:white">'.$l.',  '.$m.'</h2>';
					 for($i=0;$i<$m;$i++){
						 echo '<ul class="img-list">
					 				<div class="row">';
						 for($j=$k;$j<(($k+3<=$l)?$k+3:$l);$j++){
							 if($j==$k)echo  '<div class="col-sm-3 col-xs-12">';
							  else echo '<div class="col-sm-3 col-xs-12 col-sm-offset-1 col-xs-offset-0">';
							echo '
						  <li>
				             <!-- Item 1 -->
				    	      <a href="synopsis.php?id='.$arr[$j]['id'].'">
					             <img src="images/slider/bg11.jpg" alt="'.htmlspecialchars($arr[$j]['name']).'" width="430px" height="250px"  />
				                  <span class="text-content"><span><b>synopsis</b><br/><br/><b>'.htmlspecialchars($arr[$j]['description']).'
<br/>Release date: November 23, 2012 (India)
<br/>Director: '.htmlspecialchars($arr[$j]['director']).'
<br/>Featured song: Pi\'s Lullaby
<br/>Adapted from: '.htmlspecialchars($arr[$j]['name']).'</b></span></span>
							  </a>
...
<br/>Adapted from: Life of Pi</b></span></span>
					...
					<div class="col-sm-3 col-xs-12 col-sm-offset-1 col-xs-offset-0">
...
<br/>Adapted from: Life of Pi</b></span></span>
					...
					<div class="col-sm-3 col-xs-12 col-sm-offset-1 col-xs-offset-0">
                          ...
                          <li>				    	     
							 <a href="synopsis.html">
					             <img src="images/slider/bg6.jpg" alt="Detectives in action" width="430px" height="250px" />
		                               <span class="text-content"><span><b>synopsis</b><br/><br/><b>Pi Patel finds a way to survive in a lifeboat that is adrift in the middle of nowhere. His fight against the odds is heightened by the company of a hyena and a male Bengal tiger.
<br/>Release date: November 23, 2012 (India)
<br/>Director: Ang Lee
<br/>Featured song: Pi's Lullaby
<br/>Adapted from: Life of Pi</b></span></span>			          
					...
					<div class="col-sm-3 col-xs-12 col-sm-offset-1 col-xs-offset-0">
				    	      ...
				    	      <li>
							  <a href="synopsis.html">
					             <img src="images/slider/bg7.jpg" alt="" width="430px" height="250px" />
								      <span class="text-content"><span><b>synopsis</b><br/><br/><b>Pi Patel finds a way to survive in a lifeboat that is adrift in the middle of nowhere. His fight against the odds is heightened by the company of a hyena and a male Bengal tiger.
<br/>Release date: November 23, 2012 (India)
<br/>Director: Ang Lee
<br/>Featured song: Pi's Lullaby
					...
					<ul class="img-list">
					 <div class="row">
						  ...
						  <li>
				             <!-- Item 1 -->
				    	      <a href="">
					             <img src="images/slider/bg8.jpg" alt="Life-of-pie" width="430px" height="250px"  />
				                  <span class="text-content"><span><b>synopsis</b><br/><br/><b>Pi Patel finds a way to survive in a lifeboat that is adrift in the middle of nowhere. His fight against the odds is heightened by the company of a hyena and a male Bengal tiger.
<br/>Release date: November 23, 2012 (India)
<br/>Director: Ang Lee
<br/>Featured song: Pi's Lullaby
<br/>Adapted from: Life of Pi</b></span></span>
					...
					<div class="col-sm-3 col-xs-12 col-sm-offset-1 col-xs-offset-0">
                          ...
                          <li>				    	     
							 <a href="synopsis.html">
					             <img src="images/slider/bg9.jpg" alt="Detectives in action" width="430px" height="250px" />
		                               <span class="text-content"><span><b>synopsis</b><br/><br/><b>Pi Patel finds a way to survive in a lifeboat that is adrift in the middle of nowhere. His fight against the odds is heightened by the company of a hyena and a male Bengal tiger.
<br/>Release date: November 23, 2012 (India)
<br/>Director: Ang Lee
<br/>Featured song: Pi's Lullaby
   ...
   <section id="testimonial" class="alizarin">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="center">
                        <h2>What people say about PickurFlick</h2>
